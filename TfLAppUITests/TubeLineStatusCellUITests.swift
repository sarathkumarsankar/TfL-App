...
class TubeLineStatusCellUITests: XCTestCase {
    ...
    func testCustomTableViewCell() {
        ...
        let nameLabel = cell.staticTexts["nameLabelIdentifier"]
        let statusLabel = cell.staticTexts["statusLabelIdentifier"]
        ...
        expectation(for: label2Exists, evaluatedWith: statusLabel, handler: nil)
        waitForExpectations(timeout: 5, handler: nil)
